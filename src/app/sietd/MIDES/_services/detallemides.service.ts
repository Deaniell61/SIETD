...
@Injectable()
export class DetallemidesService {
...
private handleError(error:any):Promise<any> {
  ...
  return Promise.reject(error.message || error)
    ...
    getAll():Promise<any> {
    let url = `${this.basePath}/api/detallemides`
    ...
    delete(id):Promise<any> {
      let url = `${this.basePath}/api/detallemides/${id}`
    ...
    update(form):Promise<any> {
      let url = `${this.basePath}/api/detallemides/${form.id}`
