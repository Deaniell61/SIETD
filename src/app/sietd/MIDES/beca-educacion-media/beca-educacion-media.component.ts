...
@Component({
  selector: 'app-beca-educacion-media',
  templateUrl: './beca-educacion-media.component.html',
  styleUrls: ['./beca-educacion-media.component.css']
})
export class BecaEducacionMediaComponent implements OnInit {

  title = "Beca de Educación Media"
