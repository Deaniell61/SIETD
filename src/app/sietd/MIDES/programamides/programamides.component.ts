...
declare var $: any
@Component({
  selector: 'app-programamides',
  templateUrl: './programamides.component.html',
  styleUrls: ['./programamides.component.css']
})
export class ProgramamidesComponent implements OnInit {
  title = "Programamides"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: ProgramamidesService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/programa_mides", "_blank");
  }
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/programa_mides`
      let bar:any
      var i=0;
