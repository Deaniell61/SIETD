import { CreciendoseguroService, LocalUserObject } from './../_services/creciendoseguro.service';
...
@Component({
  selector: 'app-creciendoseguro',
  templateUrl: './creciendoseguro.component.html',
  styleUrls: ['./creciendoseguro.component.css']
})
export class CreciendoseguroComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: CreciendoseguroService,
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/creciendo_seguro`
      let bar:any
      var i=0;
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/creciendoseguro", "_blank");
  }
