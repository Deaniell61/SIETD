...
export class ServicioSocialComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: ServicioSocialService,
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/servicio_social`
      let bar:any
      var i=0;
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/servicio_social", "_blank");
  }
