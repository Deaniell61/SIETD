...
@Injectable()
export class CreciendoseguroService {
...
return Promise.reject(error.message || error)
  ...
  getAll():Promise<any> {
  let url = `${this.basePath}/api/creciendoseguro`
  ...
  delete(id):Promise<any> {
    let url = `${this.basePath}/api/creciendoseguro/${id}`
  ...
  update(form):Promise<any> {
    let url = `${this.basePath}/api/creciendoseguro/${form.id}`
