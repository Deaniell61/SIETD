...
@Injectable()
export class HogarescomunitariosService {
  ...
  return Promise.reject(error.message || error)
    ...
    getAll():Promise<any> {
    let url = `${this.basePath}/api/hogarescomunitarios`
    ...
    delete(id):Promise<any> {
      let url = `${this.basePath}/api/hogarescomunitarios/${id}`
    ...
    update(form):Promise<any> {
      let url = `${this.basePath}/api/hogarescomunitarios/${form.id}`
