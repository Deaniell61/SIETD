...
@Component({
  selector: 'app-mis-anios-dorados',
  templateUrl: './mis-anios-dorados.component.html',
  styleUrls: ['./mis-anios-dorados.component.css']
})
export class MisAniosDoradosComponent implements OnInit {

    title = "Mis Años Dorados"
    Table:any
    selectedData:any
    ...
    constructor(
      ...
      private mainService: MisAniosDoradosService,
      ...
      subirImagenes(archivo,id){
        ...
        let url = `${this.basePath}/api/carga/anios_dorados`
        let bar:any
        var i=0;
      ...
      onNavigate(){
        window.open("http://backend.sietd.alexmejicanos.com/api/download/anios_dorados", "_blank");
    }
