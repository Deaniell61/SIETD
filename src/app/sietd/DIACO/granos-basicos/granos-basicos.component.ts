...
@Component({
  selector: 'app-granos-basicos',
  templateUrl: './granos-basicos.component.html',
  styleUrls: ['./granos-basicos.component.css']
})
export class GranosBasicosComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: GranoBasicoService
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/granos_basicos", "_blank");
  }
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/granos_basicos`
      let bar:any
      var i=0;
