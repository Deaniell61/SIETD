...
import { DetalleVerduraService, LocalUserObject } from './../_services/detalle-verdura.service';
...
@Component({
  selector: 'app-detalle-verdura',
  templateUrl: './detalle-verdura.component.html',
  styleUrls: ['./detalle-verdura.component.css']
})
export class DetalleVerduraComponent implements OnInit {

  LocalUserObject: LocalUserObject;

  title = "Detalle Verdura"
  Table:any
  selectedData:any
...
VerdurasCombo:any
  ...
  constructor(
    ...
    private mainService: DetalleVerduraService,
    private parentService: VerduraService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/detalle_verduras", "_blank");
  }
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/detalle_verduras`
      let bar:any
      var i=0;
