...
@Component({
  selector: 'app-detalle-carnes',
  templateUrl: './detalle-carnes.component.html',
  styleUrls: ['./detalle-carnes.component.css']
})
export class DetalleCarnesComponent implements OnInit {

  
    title = "Detalle Carnes"
    Table:any
    selectedData:any
    ...
    constructor(
      ...
      private mainService: DetalleCarnesService,
      private parentService: CarneService,
      ...
      onNavigate(){
        window.open("http://backend.sietd.alexmejicanos.com/api/download/detalle_carnes", "_blank");
    }
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/detalle_carnes`
      let bar:any
      var i=0;
