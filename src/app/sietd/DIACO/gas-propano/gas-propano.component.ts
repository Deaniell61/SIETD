...
@Component({
  selector: 'app-gas-propano',
  templateUrl: './gas-propano.component.html',
  styleUrls: ['./gas-propano.component.css']
})
export class GasPropanoComponent implements OnInit {
  title = "Gas Propano"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: GasPropanoService
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/gas_propano", "_blank");
  }
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/gas_propano`
      let bar:any
      var i=0;
