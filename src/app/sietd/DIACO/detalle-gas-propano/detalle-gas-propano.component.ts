...
import { DetalleGasPropanoService, LocalUserObject } from './../_services/detalle-gas-propano.service';
...
@Component({
  selector: 'app-detalle-gas-propano',
  templateUrl: './detalle-gas-propano.component.html',
  styleUrls: ['./detalle-gas-propano.component.css']
})
export class DetalleGasPropanoComponent implements OnInit {

  LocalUserObject: LocalUserObject;

  title = "Detalle Gas Propano"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: DetalleGasPropanoService,
    private parentService: GasPropanoService,
  ...
  // }
  onNavigate(){
    window.open("http://backend.sietd.alexmejicanos.com/api/download/detalle_gas_propano", "_blank");
}
  subirImagenes(archivo,id){
    $('#Loading').css('display','block')
    $('#Loading').addClass('in')
    var archivos=archivo.srcElement.files;
    let url = `${this.basePath}/api/carga/detalle_gas_propano`
    let bar:any
    var i=0;
