...
@Component({
  selector: 'app-tipo-carne',
  templateUrl: './tipo-carne.component.html',
  styleUrls: ['./tipo-carne.component.css']
})
export class TipoCarneComponent implements OnInit {
  title = "Tipo de Carne"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: TipoCarneService
