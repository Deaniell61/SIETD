...
import { DetalleGranoBasicoService, LocalUserObject } from './../_services/detalle-grano-basico.service';
...
@Component({
  selector: 'app-detalle-granos-basicos',
  templateUrl: './detalle-granos-basicos.component.html',
  styleUrls: ['./detalle-granos-basicos.component.css']
})
export class DetalleGranosBasicosComponent implements OnInit {

  LocalUserObject: LocalUserObject;

  title = "Detalle Granos Basicos"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: DetalleGranoBasicoService,
    private parentService: GranoBasicoService,
    ...
    ngOnInit() {
      ...
      .then(response => {
        this.GranosbasicosCombo = response
      }).catch(error => {
        console.clear     
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/detalle_granos_basicos", "_blank");
  }
    subirImagenes(archivo,id){
      $('#Loading').css('display','block')
      $('#Loading').addClass('in')
      var archivos=archivo.srcElement.files;
      let url = `${this.basePath}/api/carga/detalle_granos_basicos`
      let bar:any
      var i=0;
