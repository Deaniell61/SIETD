...
@Injectable()
export class DetalleVerduraService {
...
return Promise.reject(error.message || error)
  ...
  getAll():Promise<any> {
  let url = `${this.basePath}/api/detalle_verduras`
  ...
  delete(id):Promise<any> {
    let url = `${this.basePath}/api/detalle_verduras/${id}`
  ...
  update(form):Promise<any> {
    let url = `${this.basePath}/api/detalle_verduras/${form.id}`
