...
@Injectable()
export class DetalleGranoBasicoService {
...
return Promise.reject(error.message || error)
  ...
  getAll():Promise<any> {
  let url = `${this.basePath}/api/detalle_granos_basicos`
  ...
  delete(id):Promise<any> {
    let url = `${this.basePath}/api/detalle_granos_basicos/${id}`
  ...
  update(form):Promise<any> {
    let url = `${this.basePath}/api/detalle_granos_basicos/${form.id}`
