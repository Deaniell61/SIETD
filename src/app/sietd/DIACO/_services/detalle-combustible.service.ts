...
@Injectable()
export class DetalleCombustibleService {
...
return Promise.reject(error.message || error)
  ...
  getAll():Promise<any> {
  let url = `${this.basePath}/api/detalle_combustible`
  ...
  delete(id):Promise<any> {
    let url = `${this.basePath}/api/detalle_combustible/${id}`
  ...
  update(form):Promise<any> {
    let url = `${this.basePath}/api/detalle_combustible/${form.id}`
