...
@Injectable()
export class DetalleGasPropanoService {
...
return Promise.reject(error.message || error)
  ...
  getAll():Promise<any> {
  let url = `${this.basePath}/api/detalle_gas_propano`
  ...
  delete(id):Promise<any> {
    let url = `${this.basePath}/api/detalle_gas_propano/${id}`
  ...
  update(form):Promise<any> {
    let url = `${this.basePath}/api/detalle_gas_propano/${form.id}`
