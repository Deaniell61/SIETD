...
export class VerduraComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: VerduraService
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/verduras", "_blank");
  }
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/verduras`
      let bar:any
      var i=0;
