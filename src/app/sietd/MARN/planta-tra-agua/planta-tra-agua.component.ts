...
@Component({
  selector: 'app-planta-tra-agua',
  templateUrl: './planta-tra-agua.component.html',
  styleUrls: ['./planta-tra-agua.component.css']
})
export class PlantaTraAguaComponent implements OnInit {

  title = "Plantas de Tratamiento de Aguas Negras"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: PlantaTraAguaService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/plantas_aguas", "_blank");
  }
  ...
  subirImagenes(archivo,id){
    ...
    let url = `${this.basePath}/api/carga/plantas_aguas`
    let bar:any
    var i=0;
