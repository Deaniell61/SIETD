...
@Component({
  selector: 'app-vertederos-legales',
  templateUrl: './vertederos-legales.component.html',
  styleUrls: ['./vertederos-legales.component.css']
})
export class VertederosLegalesComponent implements OnInit {

  title = "Vertederos Legales"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: VertederosLegalesService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/vertederos", "_blank");
  }

  rImagenes(archivo,id){
    $('#Loading').css('display','block')
    $('#Loading').addClass('in')
    var archivos=archivo.srcElement.files;
    let url = `${this.basePath}/api/api/carga/vertederos`
    let bar:any
    var i=0;
