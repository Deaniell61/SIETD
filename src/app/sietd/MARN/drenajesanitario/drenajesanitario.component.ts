...
@Component({
  selector: 'app-drenajesanitario',
  templateUrl: './drenajesanitario.component.html',
  styleUrls: ['./drenajesanitario.component.css']
})
export class DrenajesanitarioComponent implements OnInit {

  title = "Lugares Poblados Con Drenajes Sanitarios"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: DrenajesanitarioService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/drenaje_sanitario", "_blank");
  }
  ...
  subirImagenes(archivo,id){
    ...
    let url = `${this.basePath}/api/carga/drenaje_sanitario`
    let bar:any
    var i=0;
