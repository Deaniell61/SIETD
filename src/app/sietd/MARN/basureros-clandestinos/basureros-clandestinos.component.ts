...
@Component({
  selector: 'app-basureros-clandestinos',
  templateUrl: './basureros-clandestinos.component.html',
  styleUrls: ['./basureros-clandestinos.component.css']
})
export class BasurerosClandestinosComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: BasurerosClandestinosService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/basurero_clandestino", "_blank");
  }
  ...
  subirImagenes(archivo,id){
    ...
    let url = `${this.basePath}/api/carga/basurero`
    let bar:any
    var i=0;
