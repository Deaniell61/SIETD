...
@Injectable()
export class DetalleinabService {
...
return Promise.reject(error.message || error)
  ...
  getAll():Promise<any> {
  let url = `${this.basePath}/api/detalleinab`
  ...
  delete(id):Promise<any> {
    let url = `${this.basePath}/api/detalleinab/${id}`
  ...
  update(form):Promise<any> {
    let url = `${this.basePath}/api/detalleinab/${form.id}`
