import { DetalleinabService, LocalUserObject } from './../_services/detalleinab.service';
...
@Component({
  selector: 'app-detalleinab',
  templateUrl: './detalleinab.component.html',
  styleUrls: ['./detalleinab.component.css']
})
export class DetalleinabComponent implements OnInit {
  ...
  onNavigate(){
    window.open("http://backend.sietd.alexmejicanos.com/api/download/detalle_inab", "_blank");
}
...
subirImagenes(archivo,id){
  ...
  let url = `${this.basePath}/api/carga/programas_inab`
  let bar:any
  var i=0;
