...
declare var $: any
@Component({
  selector: 'app-programainab',
  templateUrl: './programainab.component.html',
  styleUrls: ['./programainab.component.css']
})
export class ProgramainabComponent implements OnInit {
  title = "Programa INAB"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: ProgramainabService,
  ...
  onNavigate(){
    window.open("http://backend.sietd.alexmejicanos.com/api/download/programas_inab", "_blank");
}
