...
declare var $: any
@Component({
  selector: 'app-consumolenia',
  templateUrl: './consumolenia.component.html',
  styleUrls: ['./consumolenia.component.css']
})
export class ConsumoleniaComponent implements OnInit {
  title = "Consumo de leña"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: ConsumoleniaService,
  ...
  onNavigate(){
    window.open("http://backend.sietd.alexmejicanos.com/api/download/consumo_lenia", "_blank");
}
  ...
  subirImagenes(archivo,id){
    ...
    let url = `${this.basePath}/api/carga/consumo_lenia`
    let bar:any
    var i=0;
