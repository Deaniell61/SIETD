...
@Component({
  selector: 'app-fenomeno',
  templateUrl: './fenomeno.component.html',
  styleUrls: ['./fenomeno.component.css']
})
export class FenomenoComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: FenomenoService,
  ...
  onNavigate(){
    window.open("http://backend.sietd.alexmejicanos.com/api/download/fenomeno", "_blank");
}
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/fenomeno`
      let bar:any
      var i=0;
