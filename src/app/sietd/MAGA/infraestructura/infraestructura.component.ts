...
export class InfraestructuraComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: InfraestructuraService
  ) { }
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/infraestructura`
      let bar:any
      var i=0;
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/infraestructura", "_blank");
  }
