...
export class PecuarioComponent implements OnInit {
  ...
  [{
    ...
    private mainService: PecuarioService, 
    private FeParentService: FenomenoService,
    private AnParentService: AnimalesService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/detalle_pecuario", "_blank");
  }
  ...
  subirImagenes(archivo,id){
    ...
    let url = `${this.basePath}/api/carga/detalle_pecuario`
    let bar:any
    var i=0;
