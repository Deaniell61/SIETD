...
@Component({
  selector: 'app-danios-pecuarios',
  templateUrl: './danios-pecuarios.component.html',
  styleUrls: ['./danios-pecuarios.component.css']
})
export class DaniosPecuariosComponent implements OnInit {

  title = "Daños Pecuarios"
