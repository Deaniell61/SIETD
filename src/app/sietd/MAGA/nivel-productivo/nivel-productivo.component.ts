...
@Component({
  selector: 'app-nivel-productivo',
  templateUrl: './nivel-productivo.component.html',
  styleUrls: ['./nivel-productivo.component.css']
})
export class NivelProductivoComponent implements OnInit {


  title = "Nivel Productivo Familia "
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: NivelProductivoFamiliaService,
  ) { }
  ...
  onNavigate(){
    window.open("http://backend.sietd.alexmejicanos.com/api/download/nivel_productivo", "_blank");
}
  subirImagenes(archivo,id){
    $('#Loading').css('display','block')
    $('#Loading').addClass('in')
    var archivos=archivo.srcElement.files;
    let url = `${this.basePath}/api/carga/nivel_productivo`
    let bar:any
    var i=0;
