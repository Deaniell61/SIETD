...
import { DetallecentrosanatorioService, LocalUserObject } from './../_services/detallecentrosanatorio.service';
...
@Component({
  selector: 'app-detallecentrosanatorio',
  templateUrl: './detallecentrosanatorio.component.html',
  styleUrls: ['./detallecentrosanatorio.component.css']
})
export class DetallecentrosanatorioComponent implements OnInit {
  LocalUserObject: LocalUserObject;
  
    title = "Detalle Centro Sanatorio"
    Table:any
    selectedData:any
    ...
    constructor(
      ...
      private mainService: DetallecentrosanatorioService,
      private SanatService: CentrosSanatariosService,
      ...
      console.log(this.LocalUserObject)
        ...
        this.SanatService.getAll()
        .then(response => {
          this.SanatorioCombo = response
        }).catch(error => {
          console.clear     
          this.createError(error) 
        })
      ...
      onNavigate(){
        window.open("http://backend.sietd.alexmejicanos.com/api/download/detalle_centro_sanatorio", "_blank");
    }
