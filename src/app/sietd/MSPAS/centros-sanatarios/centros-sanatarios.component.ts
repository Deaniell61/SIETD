...
@Component({
  selector: 'app-centros-sanatarios',
  templateUrl: './centros-sanatarios.component.html',
  styleUrls: ['./centros-sanatarios.component.css']
})
export class CentrosSanatariosComponent implements OnInit {
  title = "Centros Sanatorio"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: CentrosSanatariosService,
    private parentService: MunicipiosService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/centro_sanatorio", "_blank");
  }
    subirImagenes(archivo,id){
      $('#Loading').css('display','block')
      $('#Loading').addClass('in')
      var archivos=archivo.srcElement.files;
      let url = `${this.basePath}/api/carga/centro_sanatorio`
      let bar:any
      var i=0;
