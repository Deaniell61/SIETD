...
@Component({
  selector: 'app-tren-aseo',
  templateUrl: './tren-aseo.component.html',
  styleUrls: ['./tren-aseo.component.css']
})
export class TrenAseoComponent implements OnInit {
  title = "Tren Aseo"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: TrenAseoService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/tren_aseo  ", "_blank");
  }
