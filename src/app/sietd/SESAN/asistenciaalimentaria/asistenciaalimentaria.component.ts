...
@Component({
  selector: 'app-asistenciaalimentaria',
  templateUrl: './asistenciaalimentaria.component.html',
  styleUrls: ['./asistenciaalimentaria.component.css'],
})
export class AsistenciaalimentariaComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: AsistenciaalimentariaService,
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/asistencia_alimentaria`
      let bar:any
      var i=0;
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/asistencia_alimentaria", "_blank");
  }
