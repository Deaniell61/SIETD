...
@Component({
  selector: 'app-acciones-controladas',
  templateUrl: './acciones-controladas.component.html',
  styleUrls: ['./acciones-controladas.component.css']
})
export class AccionesControladasComponent implements OnInit {

  title = "Niños  Recuperados (No function)"
