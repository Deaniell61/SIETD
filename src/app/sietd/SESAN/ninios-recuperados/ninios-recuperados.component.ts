...
@Component({
  selector: 'app-ninios-recuperados',
  templateUrl: './ninios-recuperados.component.html',
  styleUrls: ['./ninios-recuperados.component.css']
})
export class NiniosRecuperadosComponent implements OnInit {
  title = "Niños Recuperados"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: NiniosRecuperadosService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/ninios_recuperados", "_blank");
  }
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/ninios_recuperados`
      let bar:any
      var i=0;
