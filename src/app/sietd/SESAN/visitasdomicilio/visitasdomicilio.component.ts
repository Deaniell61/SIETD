...
@Component({
  selector: 'app-visitasdomicilio',
  templateUrl: './visitasdomicilio.component.html',
  styleUrls: ['./visitasdomicilio.component.css'],
})
export class VisitasdomicilioComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: VisitasdomicilioService,
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/visitas_domicilio", "_blank");
  }
    ...
    subirImagenes(archivo,id){
      ...
      let url = `${this.basePath}/api/carga/visitas_domicilio`
      let bar:any
      var i=0;
