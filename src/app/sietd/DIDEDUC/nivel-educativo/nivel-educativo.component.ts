...
export class NivelEducativoComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: NivelEducativoService
  ) { }
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/nivel_educativo", "_blank");
  }
  ...
  subirImagenes(archivo,id){
    ...
    let url = `${this.basePath}/api/carga/nivel_educativo`
    let bar:any
    var i=0;
