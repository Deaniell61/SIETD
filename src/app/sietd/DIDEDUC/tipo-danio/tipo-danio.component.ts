...
@Component({
  selector: 'app-tipo-danio',
  templateUrl: './tipo-danio.component.html',
  styleUrls: ['./tipo-danio.component.css']
})
export class TipoDanioComponent implements OnInit {
  title = "Tipo de Daños"
  Table:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: TipoDanioService
  ) { }
