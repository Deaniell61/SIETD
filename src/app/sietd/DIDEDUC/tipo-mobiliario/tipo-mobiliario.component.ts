...
@Component({
  selector: 'app-tipo-mobiliario',
  templateUrl: './tipo-mobiliario.component.html',
  styleUrls: ['./tipo-mobiliario.component.css']
})
export class TipoMobiliarioComponent implements OnInit {
  ...
  constructor(
    ...
    private mainService: TipoMobiliarioService
  ) { }
