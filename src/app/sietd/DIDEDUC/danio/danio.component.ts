...
@Component({
  selector: 'app-danio',
  templateUrl: './danio.component.html',
  styleUrls: ['./danio.component.css']
})
export class DanioComponent implements OnInit {
  title = "Daños"
  Table:any
  parentCombo:any
  selectedData:any
  ...
  constructor(
    ...
    private mainService: DanioService,
    private parentService: TipoDanioService
  ) { }
    ...
    onNavigate(){
      window.open("http://backend.sietd.alexmejicanos.com/api/download/danio", "_blank");
  }
    subirImagenes(archivo,id){
      $('#Loading').css('display','block')
      $('#Loading').addClass('in')
      var archivos=archivo.srcElement.files;
      let url = `${this.basePath}/api/carga/danio`
      let bar:any
      var i=0;
